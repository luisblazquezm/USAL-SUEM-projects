...
#ifndef __WAIT_CONFIG_H
#define __WAIT_CONFIG_H

#include "MCUC1.h" /* include library configuration */

#ifndef WAIT_CONFIG_USE_CYCLE_COUNTER
  #define WAIT_CONFIG_USE_CYCLE_COUNTER  (0 && (MCUC1_CONFIG_CONFIG_CPU_IS_ARM_CORTEX_M && MCUC1_CONFIG_CORTEX_M>=3))
  ...
  #define WAIT_CONFIG_USE_RTOS_WAIT  (0 && MCUC1_CONFIG_SDK_USE_FREERTOS)
