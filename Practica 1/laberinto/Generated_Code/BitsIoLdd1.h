...
#define BitsIoLdd1_PORT_MASK 0x00E00000U /*!< Mask of the allocated pin from the port */
#define BitsIoLdd1_PORT_VALID_VALUE_MASK 0x07 /*!< Mask of the allocated pins from the port as the first pin would be zero i.e. valid bits to be set in method PutVal */
